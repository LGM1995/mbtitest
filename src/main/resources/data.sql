...
INSERT INTO answer(id, content, personality, questuon_id) VALUES (1, 'SNS나 가족이나 친구에게 얘기하며 생각을 공유한다.', 'E', 1);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (2, '굳이 주의 사람들에 털놓지 않고 혼자서 생각하는 편이다.', 'I', 1);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (3, '"불편하네.." 하고 넘기는 편이다.', 'S', 2);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (4, '불편한 이유와 개선방안 등을 생각을 하는 편이다.', 'N', 2);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (5, '불편한 감정이 티가 난다.', 'T', 3);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (6, '기분 나쁘지만 따지지는 않고, 같이 쇼핑 중인 친구에게 욕한다.', 'F', 3);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (7, '계획을 잘 세우고 짜여진 계획대로 한다.', 'J', 4);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (8, '최후의 순간까지 미루다가 시간에 쫓겨 허겁지겁한다.', 'P', 4);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (9, '얘기를 많이 하며 분위기를 주도하는 편이다.', 'E', 5);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (10, '얘기를 많이 하지 않고 때로는 의미 없게 느껴질 때도 있다.', 'I', 5);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (11, '꾸준하고 참을성 있다는 말을 자주 듣는 편이다.', 'S', 6);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (12, '독특하고 창의력, 상상력이 풍부하다는 말을 듣는 편이다.', 'N', 6);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (13, '친구가 차인 이유와 상대의 행동에 대해 분석해 준다.', 'T', 7);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (14, '친구 눈물을 닦아주며 밤이 새도록 같이 욕해준다.', 'F', 7);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (15, '미리 검색해본 루트로 가거나 산 입구에서 지도를 체크한 후 출발한다.', 'J', 8);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (16, '사람들이 가는 길이 맞는길. 굳이 계획 할 필요 없다~!', 'P', 8);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (17, '시간이 걸리는 일이나 놀이는 싫증을 빨리 내고 새로운 활동을 원한다.', 'E', 9);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (18, '자신의 의견이나 불편한 감정을 표현하는데 재빠르지 않은 편이다.', 'I', 9);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (19, '주변 사람들의 얼굴, 키나 다른 특징들을 잘 기억한다.', 'S', 10);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (20, '종종 물건을 잃어버리거나 어디에 두었는지 기억을 못 할 때가 있다.', 'N', 10);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (21, '다음 요리의 발전을 위해 어떤 부분이 잘못됐는지 말해주는게 좋다.', 'T', 11);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (22, '"고마워~ 이거 만드느라 힘들었을 텐데 고생했어"라는 반응이 더 좋다.', 'F', 11);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (23, '예정에 없던 일로 계획을 바꾸게 되면 힘들어한다.', 'J', 12);
INSERT INTO answer(id, content, personality, questuon_id) VALUES (24, '신발이나 옷이 떨어져도 불편하지 않다.', 'P', 12);

INSERT INTO result(id, name, title, content, count, mbti) VALUES (
